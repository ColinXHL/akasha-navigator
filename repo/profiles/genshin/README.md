...
- 智能鼠标检测：在手动穿透已开启时，根据游戏鼠标状态自动切换点击穿透
- 方向标记插件：识别攻略视频中的方向指示
- 原神自动化插件：可通过快捷键切换自动拾取和自动剧情
...
| `bilibili-page-list` | B 站分 P 列表，便于快速切换攻略视频章节 |
| `akasha-genshin-automation` | 原神自动化插件，默认使用 F9 切换自动拾取、F12 切换自动剧情 |
...
3. 先开启播放器的手动穿透模式
4. 在游戏中显示鼠标时，播放器自动进入点击穿透模式
5. 关闭手动穿透时，智能鼠标效果会立即停止
