...
namespace AkashaNavigator.Tests.ViewModels
{
    ...
    public class HistoryWindowViewModelTests
    {
        ...
        {
            // Arrange
            var initialItems = new List<HistoryItem>
            {
                new HistoryItem { Id = 1, Url = "https://example.com/1", Title = "初始", VisitTime = DateTime.Now }
            };
            var updatedItems = new List<HistoryItem>
            {
                new HistoryItem { Id = 2, Url = "https://example.com/2", Title = "更新", VisitTime = DateTime.Now }
            };
        ...
        {
            // Arrange
            var searchResults = new List<HistoryItem>
            {
                new HistoryItem { Id = 1, Url = "https://example.com/search", Title = "搜索结果", VisitTime = DateTime.Now }
            };
        ...
        public void SearchText_WithMatchingResults_SetsIsEmptyToFalse()
        {
            ...
            var searchResults = new List<HistoryItem>
            {
                new HistoryItem { Id = 1, Url = "https://example.com/game", Title = "游戏攻略", VisitTime = DateTime.Now }
            };
        ...
        public void DeleteCommand_WithValidId_CallsDeleteHistoryAndReloads()
        {
            ...
            var remainingItems = new List<HistoryItem>
            {
                new HistoryItem { Id = 1, Url = "https://example.com/1", Title = "页面1", VisitTime = DateTime.Now }
            };
        ...
        [Fact]
        public void ClearAllCommand_WhenNotEmpty_CallsClearHistoryAndReloads()
        {
            // Arrange
            var historyItems = new List<HistoryItem>
            {
        ...
        [Fact]
        public void ClearAllCommand_AfterClearing_SetsIsEmptyToTrue()
        {
            // Arrange
            var historyItems = new List<HistoryItem>
            {
