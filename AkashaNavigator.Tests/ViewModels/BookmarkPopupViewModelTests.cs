...
namespace AkashaNavigator.Tests.ViewModels
{
    ...
    public class BookmarkPopupViewModelTests
    {
        ...
        public void Constructor_WithValidDataService_LoadsBookmarksOnCreation()
        {
            ...
            {
                new BookmarkItem { Id = 1, Url = "https://example.com/1", Title = "书签1", AddTime = DateTime.Now, SortOrder = 1 },
                new BookmarkItem { Id = 2, Url = "https://example.com/2", Title = "书签2", AddTime = DateTime.Now, SortOrder = 2 }
            };
        ...
        {
            // Arrange
            var initialItems = new List<BookmarkItem>
            {
                new BookmarkItem { Id = 1, Url = "https://example.com/1", Title = "初始", AddTime = DateTime.Now, SortOrder = 1 }
            };
            var updatedItems = new List<BookmarkItem>
            {
                new BookmarkItem { Id = 2, Url = "https://example.com/2", Title = "更新", AddTime = DateTime.Now, SortOrder = 1 }
            };
        ...
        public void DeleteCommand_WithValidId_CallsDeleteBookmarkAndReloads()
        {
            ...
            var remainingItems = new List<BookmarkItem>
            {
                new BookmarkItem { Id = 1, Url = "https://example.com/1", Title = "书签1", AddTime = DateTime.Now, SortOrder = 1 }
            };
        ...
        [Fact]
        public void ClearAll_WhenNotEmpty_CallsClearBookmarksAndReloads()
        {
            // Arrange
            var bookmarkItems = new List<BookmarkItem>
            {
        ...
        [Fact]
        public void ClearAll_AfterClearing_SetsIsEmptyToTrue()
        {
            // Arrange
            var bookmarkItems = new List<BookmarkItem>
            {
        ...
        public void LoadBookmarks_WithUnsortedBookmarks_MaintainsServiceOrder()
        {
            ...
            var bookmarkItems = new List<BookmarkItem>
            {
                new BookmarkItem { Id = 1, Url = "https://example.com/1", Title = "第一", AddTime = DateTime.Now, SortOrder = 1 },
                new BookmarkItem { Id = 2, Url = "https://example.com/2", Title = "第二", AddTime = DateTime.Now, SortOrder = 2 },
                new BookmarkItem { Id = 3, Url = "https://example.com/3", Title = "第三", AddTime = DateTime.Now, SortOrder = 3 }
            };
        ...
        public void LoadBookmarks_WithCustomSortOrder_PreservesSortOrder()
        {
            ...
            var bookmarkItems = new List<BookmarkItem>
            {
                new BookmarkItem { Id = 1, Url = "https://example.com/z", Title = "最后", AddTime = DateTime.Now, SortOrder = 100 },
                new BookmarkItem { Id = 2, Url = "https://example.com/a", Title = "最前", AddTime = DateTime.Now, SortOrder = 1 },
                new BookmarkItem { Id = 3, Url = "https://example.com/m", Title = "中间", AddTime = DateTime.Now, SortOrder = 50 }
            };
        ...
        {
            // Arrange
            var searchResults = new List<BookmarkItem>
            {
                new BookmarkItem { Id = 1, Url = "https://example.com/search", Title = "搜索结果", AddTime = DateTime.Now, SortOrder = 1 }
            };
        ...
        {
            // Arrange
            var fullBookmarks = new List<BookmarkItem>
            {
                new BookmarkItem { Id = 1, Url = "https://example.com/1", Title = "书签1", AddTime = DateTime.Now, SortOrder = 1 },
                new BookmarkItem { Id = 2, Url = "https://example.com/2", Title = "书签2", AddTime = DateTime.Now, SortOrder = 2 }
            };
        ...
        public void SearchText_WithMatchingResults_SetsIsEmptyToFalse()
        {
            ...
            var searchResults = new List<BookmarkItem>
            {
                new BookmarkItem { Id = 1, Url = "https://example.com/game", Title = "游戏攻略", AddTime = DateTime.Now, SortOrder = 1 }
            };
