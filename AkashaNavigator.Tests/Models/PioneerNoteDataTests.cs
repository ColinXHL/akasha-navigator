...
var data = new PioneerNoteData
{
Folders = new List<NoteFolder> { new() { Name = "Test Folder" } },
...
Assert.NotNull(folder.CreatedTime);
...
Assert.NotNull(item.RecordedTime);
...
Name = "Game Guide",
ParentId = null,
CreatedTime = new DateTime(2024, 1, 1, 10, 0, 0, DateTimeKind.Utc),
Icon = "🎮",
SortOrder = 0
},
new NoteFolder
...
ParentId = "folder1",
CreatedTime = new DateTime(2024, 1, 2, 10, 0, 0, DateTimeKind.Utc),
Icon = "👹",
SortOrder = 1
}
},
...
Id = "item1",
Title = "UID12345-亚洲服",
Url = "https://example.com/uid12345",
FolderId = "folder2",
...
Name = "Test Folder",
ParentId = null,
CreatedTime = new DateTime(2024, 6, 15, 14, 30, 0, DateTimeKind.Utc),
Icon = "📁",
SortOrder = 10
}
},
...
{
new NoteFolder { Id = "f1", Name = "First", SortOrder = 2 },
...
// 验证每个文件夹的项
Assert.Equal(1, data.Items.FindAll(i => i.FolderId == null).Count);  // 根目录项
Assert.Equal(1, data.Items.FindAll(i => i.FolderId == "sub1").Count);  // sub1 项
Assert.Equal(1, data.Items.FindAll(i => i.FolderId == "sub2").Count);  // sub2 项
Assert.Equal(1, data.Items.FindAll(i => i.FolderId == "subsub1").Count); // subsub1 项
}
