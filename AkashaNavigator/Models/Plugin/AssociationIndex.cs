...
public class PluginReferenceEntry
{
    ...
    {
        return new PluginReferenceEntry { PluginId = reference.PluginId, Enabled = reference.Enabled,
    ...
    {
        return new PluginReference { PluginId = PluginId, Enabled = Enabled, AddedAt = AddedAt };
    }
}
...
public class AssociationIndex
{
    ...
    public static AssociationIndex LoadFromFile(string filePath)
    {
        ...
        try
        {
            ...
            return JsonSerializer.Deserialize<AssociationIndex>(json, _jsonOptions) ?? new AssociationIndex();
        }
        catch
        {
            return new AssociationIndex();
