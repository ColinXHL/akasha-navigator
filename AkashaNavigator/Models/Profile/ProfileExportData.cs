...
public class ProfileImportResult
{
    ...
    {
        return new ProfileImportResult { IsSuccess = true, ProfileId = profileId,
    ...
    {
        return new ProfileImportResult { IsSuccess = false, ErrorMessage = errorMessage };
    }
    ...
    {
        return new ProfileImportResult { IsSuccess = false, ProfileId = profileId, ProfileExists = true,
