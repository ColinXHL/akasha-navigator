...
public class UpdateResult
{
    ...
    {
        return new UpdateResult { IsSuccess = true, OldVersion = oldVersion, NewVersion = newVersion };
    }
    ...
    {
        return new UpdateResult { IsSuccess = false, ErrorMessage = errorMessage };
    }
    ...
    {
        return new UpdateResult { IsSuccess = false, ErrorMessage = "没有可用的更新" };
    }
}
}
