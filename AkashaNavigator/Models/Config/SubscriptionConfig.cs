...
#region Plugin Methods
    ...
    public List<string> GetSubscribedPlugins(string profileId)
    {
        ...
        return PluginSubscriptions.TryGetValue(profileId, out var plugins) ? new List<string>(plugins)
                                                                           : new List<string>();
    }
    ...
    public bool IsPluginSubscribed(string pluginId, string profileId)
    {
        ...
        return PluginSubscriptions.TryGetValue(profileId, out var plugins) && plugins.Contains(pluginId);
    }
