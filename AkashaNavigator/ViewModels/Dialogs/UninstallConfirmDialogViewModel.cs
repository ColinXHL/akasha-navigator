...
namespace AkashaNavigator.ViewModels.Dialogs
{
    ...
    public partial class UninstallConfirmDialogViewModel : ObservableObject
    {
        ...
        /// </summary>
        public UninstallConfirmDialogViewModel(
        ...
        private bool PerformUninstall()
        {
            ...
            else
            {
                ...
                _logService.Error(nameof(UninstallConfirmDialogViewModel),
                    "插件 {PluginId} 卸载失败: {ErrorMessage}", PluginId, ErrorMessage ?? "未知错误");
                return false;
            }
        }
    }
