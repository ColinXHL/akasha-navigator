...
#region Built - in Action Names
    ...
    /// <summary>重置透明度</summary>
    public const string ActionResetOpacity = "ResetOpacity";
    /// <summary>增加播放速率</summary>
    public const string ActionIncreasePlaybackRate = "IncreasePlaybackRate";
    /// <summary>减少播放速率</summary>
    public const string ActionDecreasePlaybackRate = "DecreasePlaybackRate";
    /// <summary>重置播放速率</summary>
    public const string ActionResetPlaybackRate = "ResetPlaybackRate";
    /// <summary>切换窗口可见性</summary>
...
#region Private Methods
    ...
    private void RegisterBuiltinActions()
    {
        ...
        RegisterAction(ActionResetOpacity, () => ResetOpacity?.Invoke(this, EventArgs.Empty));
        RegisterAction(ActionIncreasePlaybackRate, () => IncreasePlaybackRate?.Invoke(this, EventArgs.Empty));
        RegisterAction(ActionDecreasePlaybackRate, () => DecreasePlaybackRate?.Invoke(this, EventArgs.Empty));
