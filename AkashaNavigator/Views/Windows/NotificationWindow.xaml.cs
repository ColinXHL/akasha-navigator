...
#region Constructor
    ...
    public NotificationWindow(NotificationConfig config)
    {
        ...
        // 设置自动关闭定时器
        _autoCloseTimer = new DispatcherTimer { Interval = TimeSpan.FromMilliseconds(config.DurationMs) };
...
#region Private Methods
    ...
    {
        return type switch { NotificationType.Info => (Color.FromRgb(0x00, 0x78, 0xD4), "ℹ"),    // 蓝色 #0078D4
