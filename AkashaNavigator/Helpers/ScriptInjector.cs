...
namespace AkashaNavigator.Helpers
{
    ...
    public static class ScriptInjector
    {
        ...
        /// CSS 嵌入资源名称
        /// </summary>
        private const string StylesResourceName = "AkashaNavigator.Scripts.InjectedStyles.css";

        /// <summary>
        /// JS 嵌入资源名称
        /// </summary>
        private const string ScriptsResourceName = "AkashaNavigator.Scripts.InjectedScripts.js";
